...
**MCP server** - `swarmvault mcp` exposes the vault to any compatible agent client over stdio, including context-pack, task-ledger, compatibility memory-task, and retrieval health tools.
